...
private:
	...
	void *handle;
	typedef void *(*createAV1Controller_t)(const aom::AV1RateControlRtcConfig &rc_cfg);
	typedef bool(*UpdateRateControl_AV1_t)(void *controller, const aom::AV1RateControlRtcConfig &rc_cfg);
	typedef int (*GetQP_AV1_t)(void *controller);
	typedef aom::FrameDropDecision (*ComputeQP_AV1_t)(void *controller, const aom::AV1FrameParamsRTC &frame_params);
	...
	typedef bool (*GetSegmentationData_AV1_t)(void *controller, aom::AV1SegmentationData *segmentation_data);
